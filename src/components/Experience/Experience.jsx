        ...
        <div className="container">
          <div className="flex justify-between">
            <div className="w-[40%] mt-9.5">
              ...
              <p className="text-[16px] font-lato font-normal text-[#7b7b7b] leading-6.5 mb-11.25">
               ...
               <div className="btn">
                        <button className='py-3.5 px-6.25 text-[16px ] cursor-pointer font-lato font-semibold bg-[#DAF6EB] text-[#06C279] rounded-[5px]'>All Services</button>
                    </div>
            </div>
            <div className="w-[45%]">
